...
enum TokenType {
    OPCODE, REGISTER, IMMEDIATE, MEMORY, LABEL, DIRECTIVE, UNKNOWN, ERROR, STRING, STANDALONE
};

// Global sets and maps - Use `constexpr` for simple cases, and `static` to avoid multiple definitions.
namespace riscv {
...
// Define instruction types as functions instead of static variables
struct RTypeInstructions {
    static const InstructionEncoding& getEncoding() {
        static const InstructionEncoding encoding = {
            {{"add", "0000000"}, {"sub", "0100000"}, {"mul", "0000001"}, {"div", "0000001"},
             {"rem", "0000001"}, {"and", "0000000"}, {"or", "0000000"}, {"xor", "0000000"},
             {"sll", "0000000"}, {"slt", "0000000"}, {"sra", "0100000"}, {"srl", "0000000"}},
            {{"add", "000"}, {"sub", "000"}, {"mul", "000"}, {"div", "100"},
             {"rem", "110"}, {"and", "111"}, {"or", "110"}, {"xor", "100"},
             {"sll", "001"}, {"slt", "010"}, {"sra", "101"}, {"srl", "101"}},
            {{"add", "0110011"}, {"sub", "0110011"}, {"mul", "0110011"}, {"div", "0110011"},
             {"rem", "0110011"}, {"and", "0110011"}, {"or", "0110011"}, {"xor", "0110011"},
...
struct ITypeInstructions {
    static const InstructionEncoding& getEncoding() {
        static const InstructionEncoding encoding = {
            ...
            {{"addi", "000"}, {"andi", "111"}, {"ori", "110"}, {"slti", "010"}, {"sltiu", "011"},
             {"xori", "100"}, {"lb", "000"}, {"lh", "001"}, {"lw", "010"}, {"ld", "011"},
             {"jalr", "000"}, {"slli", "001"}, {"srli", "101"}, {"srai", "101"}},
            {{"addi", "0010011"}, {"andi", "0010011"}, {"ori", "0010011"}, {"slti", "0010011"},
             {"sltiu", "0010011"}, {"xori", "0010011"}, {"lb", "0000011"}, {"lh", "0000011"},
             {"lw", "0000011"}, {"ld", "0000011"}, {"jalr", "1100111"}, {"slli", "0010011"},
             {"srli", "0010011"}, {"srai", "0010011"}}
        };
        return encoding;
    }
};
